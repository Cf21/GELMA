...
[beta,resnorm] = lsqcurvefit(mdl_vec,beta0,x_vec, y_vec,lb,ub,optimoptions(@lsqnonlin,'Algorithm','trust-region-reflective', ... 
    'MaxFunctionEvaluations',30000,...%'SubproblemAlgorithm','cg','ScaleProblem', 'jacobian',...
    'MaxIterations',30000,'DiffMinChange', 1e-5 ,'FunctionTolerance',1e-10,'StepTolerance',1e-10, 'FiniteDifferenceType', 'central'));
